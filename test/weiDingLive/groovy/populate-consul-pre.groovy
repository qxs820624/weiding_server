...
Consul.put(null, 'configuration/apps', [
    ...
    'user.info.souyue.url':'http://103.29.134.225:8888/d3api2/pc/user/user.redis.info.groovy',
    'live.heart.task.time':60,

    'gift.list.url':'https://sybpre.zhongsou.com/api/giftlist',
    'gift.payment.url':'https://sybpre.zhongsou.com/api/payusergift',
    'user.sybinfo.url':'https://sybpre.zhongsou.com/api/getuserinfo',
    'user.charminfo.url':'https://sybpre.zhongsou.com/api/getUserCharm',
    'usercenter.encrypt.url':'http://usercenterpre.zhongsou.com/api/user/encrypt',
    'gift.payorder.url':'https://sybpre.zhongsou.com/payliveapi/payorder',

    'short.url.master':'202.108.1.140:6380',
    'short-url.slaves':'202.108.1.142:6380,202.108.1.144:6380,202.108.1.145:6380',
    'live.share.url':'http://moltest.zhongsou.com/Widgetshare/index',//互動直播對應的預告分享url
    'live.pgc.share.url':'http://moltest.zhongsou.com/meetingshare/index',//普通的會議直播
    'live.pay.share.url':'http://moltest.zhongsou.com/paylivesy/index',//付費直播
    'live.group.share.url':'http://moltest.zhongsou.com/paylivewx/album',//直播系列分享地址

    'live.kestrel.servers':'103.7.220.155:22134',
    'live.kestrel.name.blog':'live_blog_pre',
    ...
    'live.data.kafka.servers':'103.7.220.171:9092,103.7.220.172:9092,103.7.220.173:9092',
    ...
    'vest.payGift.url': 'https://sybpre.zhongsou.com/api/vestPayGift',
    'live.user.pay.list.url':'https://sybpre.zhongsou.com/payliveapi/getUserPayLiveInfo',

    'live.getuserpay.url':'https://sybpre.zhongsou.com/payliveapi/getuserpay',
    'live.pay.abstract.url':'http://moltest.zhongsou.com/payliveapp/H5Abstract',
    'live.pay.invite.url':'http://moltest.zhongsou.com/payliveapp/H5Invitation_Ranking',
    'live.pay.record.url':'https://sybpre.zhongsou.com/payliveapi/recordApi',
    'live.statistic.nginx.url':'http://lv.souyue.mobi/live/live.nginx.log.groovy',

    'live.message.url':'http://103.29.134.225/d3api2/user/sendMobileMsg.groovy',
    'live.get.appname.url':'http://ydyoltest.zhongsou.com/WebApi/getname',
    'live.get.appname.signkey':'zs_!@#$%^&*&^%$#@webservice',

    'live.foreshow.pay.status':'https://sybpre.zhongsou.com/payliveapi/getSeriesPayStatus',

    'live.try.look.time':'600000',
    'live.souyue.api.url':"http://103.29.134.225",

    'live.access.check.url': "http://gctvoltest.zhongsou.com/Mobile/checkLiveAccess",
    'live.access.check.appIds':"com.gctv,com.zsgctv",
    'live.fans.sync.url': "http://ydyoltest.zhongsou.com/mcp/gctv/live.sdk.follow.groovy",
    'live.fans.sync.appIds':"com.gctv,com.zsgctv,com.gedoushijie,com.zsgedoushijie,com.gedoushijie2017",

    'live.flux.callback.php':"https://sybpre.zhongsou.com/payliveapi/dealflowcost",
    'qcloud.play.sign.key':"d48e4e43862530f94c498aeda9ae8c9f",
    'pili.sign.key':"a8ba0988d2713240ddc1864c337a48c5",

    'brief.url':"http://moltest.zhongsou.com/payliveapp/H5Abstract",
])
