...
ApiUtils.processNoEncry {
    ...
    Assert.isNotBlankParam(params, "childSortNum")   //排序值
    ...
    long sortNum
    try {
        sortNum = (params.childSortNum ?:0)as long
    ...
    int res = liveService.sortForeshowChild([foreshowId:foreshowId,sortNum:sortNum,appId:appId])
    result.status=res
    if (res ==1) {
        result.msg="成功"
    } else{
